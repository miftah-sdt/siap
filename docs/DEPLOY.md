...
| **API base** (`/v1`) | https://roof-mouse-specialties-stat.trycloudflare.com/v1 |
...
| Name | Value |
|------|--------|
| `SIAP_API_URL` | `https://roof-mouse-specialties-stat.trycloudflare.com/v1` |
...
2. Dapat URL: `https://roof-mouse-specialties-stat.trycloudflare.com`

### Verifikasi

```bash
curl https://roof-mouse-specialties-stat.trycloudflare.com/health
```
...
flutter build web --release ^
  --base-href "/siap/" ^
  --dart-define=API_BASE_URL=https://roof-mouse-specialties-stat.trycloudflare.com/v1

# APK untuk Nox
flutter build apk --release --dart-define=API_BASE_URL=https://roof-mouse-specialties-stat.trycloudflare.com/v1
```
...
- [ ] Secret `SIAP_API_URL` = `https://roof-mouse-specialties-stat.trycloudflare.com/v1` di repo `siap`
