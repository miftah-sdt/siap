...
/// ```bash
/// openssl s_client -connect roof-mouse-specialties-stat.trycloudflare.com:443 \
///   -servername roof-mouse-specialties-stat.trycloudflare.com </dev/null 2>/dev/null \
