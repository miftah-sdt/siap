...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( DashboardSummary summary,  DashboardCharts charts)?  success,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case DashboardInitial() when initial != null:
return initial();case DashboardLoading() when loading != null:
return loading();case DashboardSuccess() when success != null:
return success(_that.summary,_that.charts);case DashboardError() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( DashboardSummary summary,  DashboardCharts charts)  success,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case DashboardInitial():
return initial();case DashboardLoading():
return loading();case DashboardSuccess():
return success(_that.summary,_that.charts);case DashboardError():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( DashboardSummary summary,  DashboardCharts charts)?  success,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case DashboardInitial() when initial != null:
return initial();case DashboardLoading() when loading != null:
return loading();case DashboardSuccess() when success != null:
...
class DashboardSuccess implements DashboardState {
  const DashboardSuccess({required this.summary, required this.charts});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DashboardSuccess&&(identical(other.summary, summary) || other.summary == summary)&&(identical(other.charts, charts) || other.charts == charts));
}


@override
int get hashCode => Object.hash(runtimeType,summary,charts);

@override
String toString() {
  return 'DashboardState.success(summary: $summary, charts: $charts)';
}
...
@useResult
$Res call({
 DashboardSummary summary, DashboardCharts charts
});
...
/// Create a copy of DashboardState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? summary = null,Object? charts = null,}) {
  return _then(DashboardSuccess(
summary: null == summary ? _self.summary : summary // ignore: cast_nullable_to_non_nullable
as DashboardSummary,charts: null == charts ? _self.charts : charts // ignore: cast_nullable_to_non_nullable
as DashboardCharts,
  ));
}
